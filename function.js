...
document.addEventListener('DOMContentLoaded', () => {
  ...
  setInterval(() => {
    ...
    const { icon, text } = iconSequence[currentIndex];
...
// State [control global del codigo]
let currentReviewIndex = 0; //indiice actual del carrusel
let autoPlayInterval; //ID del setInterval para el carrusel
let isAutoPlaying = true; //controla el autoply del carrusel
...
function filterProjects(filter) {
    ...
    renderProjects(filteredProjects.slice(0, 6)); // muestra solo 6 filtrados
